...
def getweather():
    ...
    if start!=-1 and end!=-1:
        return weathertext
def radio(channel):
    os.system("omxplayer /home/pi/customscripts/blup.mp3")
    ...
    if channel=="puls":os.system("omxplayer http://br-puls-live.cast.addradio.de/br/puls/live/mp3/mid")
def shutdown():
    os.system("omxplayer /home/pi/customscripts/blup.mp3")
    time.sleep(1)
    os.system("/usr/bin/sudo /sbin/shutdown 0")
def play(message):
    os.system("omxplayer /home/pi/customscripts/blup.mp3")
    print("Output: "+message)
    # process Unicode text
    with io.open("/home/pi/customscripts/message.txt",'w',encoding='utf8') as f:
        f.write(message)
    #write tts out to file like object or mp3 and play it
#    mp3_fp = BytesIO()
    tts = gTTS(message, lang='de')
#    tts.write_to_fp(mp3_fp)
    tts.save('/home/pi/customscripts/out.mp3')
    os.system("omxplayer /home/pi/customscripts/out.mp3")
...
#    if command=="test": play("Test Test Test")
    ...
    if command=="puls": radio("puls")
    if command=="ausschalten": shutdown()
     
    
def listenloop():
    if not os.path.exists("/home/pi/customscripts/model"):
        print ("Please download the model from https://alphacephei.com/vosk/models and unpack as 'model' in the current folder.")
        exit (1)
    model = Model("/home/pi/customscripts/model")
...
os.system("omxplayer /home/pi/customscripts/start.mp3")
listenloop()
